...
import 'package:rsm/util/app_constants.dart';
...
class LocalizationProvider extends ChangeNotifier {
  ...
  Locale _locale = Locale(AppConstants.languages[0].languageCode?? 'en', AppConstants.languages[0].countryCode);
  bool _isLtr = true;
  ...
  _loadCurrentLanguage() async {
    _locale = Locale(sharedPreferences.getString(AppConstants.LANGUAGE_CODE) ?? AppConstants.languages[0].languageCode ?? 'en',

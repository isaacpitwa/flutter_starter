...
import 'package:rsm/data/datasource/remote/dio/dio_client.dart';
import 'package:rsm/data/datasource/remote/exception/api_error_handler.dart';
import 'package:rsm/data/model/response/base/api_response.dart';
import 'package:rsm/data/model/response/onboarding_model.dart';
  ...
  Future<ApiResponse> getOnBoardingList() async {
    try {
      List<OnboardingModel> onBoardingList = [
        OnboardingModel('assets/images/onboarding_image_one.png', 'Welcome to Great Habib', 'Here shopping is easy and fun with 50 thousands products, exclusive deals, offers and promotions.'),
